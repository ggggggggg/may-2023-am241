...
pulse_files = files("5004") #runnum 0000 is short run. 0001 is long one
...
pulse_inds_filter = ljh.fasttrig_filter(imax=my_imax, filter=filter, threshold=1000) # imax=ljh.nPulses//10
